...
from Subscriptls.dictionary import Dictionary
...
if __name__ == '__main__':
    ...
    summary_dico = Dictionary.read_vocab("NewTest.summary_vocab")
    summary_data = Dictionary.index_summary("NewTest.summary", "NewTest.summary_label", summary_dico,
                                            "NewTest.summary.pth", max_len=600)
