...
if __name__ == '__main__':
    ...
    table_dico = Dictionary.read_vocab("NewTest.gtable_vocab")
    table_data = Dictionary.index_table("NewTest.gtable", "NewTest.gtable_label", table_dico, "NewTest.gtable.pth")
