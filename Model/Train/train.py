...
def get_parser():
    ...
    parser.add_argument("--cs_step", type=bool_flag, default=True,
                        help="content selection step")
    parser.add_argument("--lm_step", type=bool_flag, default=True,
                        help="language modeling step")
    parser.add_argument("--sm_step", type=bool_flag, default=True,
                        help="summarization step")
    parser.add_argument("--sm_step_with_cc_loss", type=bool_flag, default=True,
                        help="summarization step with conditional copy loss")
    parser.add_argument("--sm_step_with_cs_proba", type=bool_flag, default=True,
                        help="summarization step with conditional copy loss")
    # data
    parser.add_argument("--train_cs_table_path", type=str, default="../Data Processing/train.gtable.pth",
                        help="train content selection table data pth")
    parser.add_argument("--train_sm_table_path", type=str, default="../Data Processing/train.gtable.pth",
                        help="train summarization table data pth")
    parser.add_argument("--train_sm_summary_path", type=str, default="../Data Processing/train.summary.pth",
                        help="train summarization summary data pth")
    parser.add_argument("--valid_table_path", type=str, default="../Data Processing/valid.gtable.pth",
                        help="valid table data pth")
    parser.add_argument("--valid_summary_path", type=str, default="../Data Processing/valid.summary.pth",
    ...
    # training parameters
    parser.add_argument("--split_data", type=bool_flag, default=True,
    ...
    parser.add_argument("--validation_metrics", type=str, default="valid_mt_bleu",
    ...
    parser.add_argument("--lambda_lm", type=str, default="1",
    ...
    parser.add_argument("--eval_bleu", type=bool_flag, default=True,
                        help="early stopping in beam search")
