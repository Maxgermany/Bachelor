...
def get_parser():
    ...
    # main parameters
    parser.add_argument("--model_path", type=str, default="../experiments/First Experiment/2/best-valid_mt_bleu.pth", help="Experiment dump path")
    parser.add_argument("--batch_size", type=int, default=16, help="Number of sentences per batch")

    # model / output paths
    parser.add_argument("--table_path", type=str, default="../Data Processing/valid.gtable", help="table path")
    parser.add_argument("--output_path", type=str, default="../experiments/First Experiment/valid.gtable_out", help="Output path")
